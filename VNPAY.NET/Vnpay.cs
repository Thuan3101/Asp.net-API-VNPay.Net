...
namespace VNPAY.NET
{
    public class Vnpay : IVnpay
    {
        ...
        private VnpayDbContext _dbContext;
        ...
        public Vnpay(VnpayDbContext dbContext)
        {
        ...
        // Phương thức lấy danh sách Payments
        public async Task<(List<Payment> Payments, int TotalCount)> GetPaymentsAsync(int page, int pageSize, string sort)
        {
